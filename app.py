...
# --- STYLESHEET (IMPORTED FROM APP-4) ---
def load_css():
    ...
    # ==========================
        ...
        if not DEPENDENCIES_INSTALLED:
            ...
            with tab_verify:
                ...
                with col_cam:
                    # UPDATED STYLING FOR CODE BOX
                    st.markdown(f"""
                        <div class="session-container">
                            <div class="session-label">SPEAK THIS CODE INTO THE CAMERA</div>
